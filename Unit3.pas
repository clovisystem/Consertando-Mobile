...
begin
    procura:=Edit1.Text;
          ...
          //Try
                ...
                If (Edit1.Text = 'MONITOR NÃO LIGA') Or (Edit1.Text = 'MONITOR NAO LIGA') Or (Edit1.Text = 'MONITOR COM DEFEITO') Or (Edit1.Text = 'MONITOR') Or (Edit1.Text = 'MONITOR NÃO FUNCIONA') Or (Edit1.Text = 'MONITOR NAO FUNCIONA') Or (Edit1.Text = 'MONITOR QUEBRADO') Then
                ...
                If (Edit1.Text = 'NÃO MEMORIZA') Or (Edit1.Text = 'NAO MEMORIZA') Or (Edit1.Text = 'MEMÓRIA') Or (Edit1.Text = 'MEMORIA') Or (Edit1.Text = 'SEM MEMÓRIA') Or (Edit1.Text = 'SEM MEMORIA') Or (Edit1.Text = 'NÃO LEMBRA') Or (Edit1.Text = 'NAO LEMBRA') Or (Edit1.Text = 'ESQUECE') Then
                ...
                If (Edit1.Text = 'MUDO') Or (Edit1.Text = 'TV MUDA') Or (Edit1.Text = 'TELEVISÃO MUDA') Or (Edit1.Text = 'TELEVISAO MUDA') Or (Edit1.Text = 'ESTÁ MUDO') Or (Edit1.Text = 'ESTA MUDO') Or (Edit1.Text = 'FICOU MUDO') Or (Edit1.Text = 'MUTE') Or (Edit1.Text = 'DEFEITO DE MUTE') Then
